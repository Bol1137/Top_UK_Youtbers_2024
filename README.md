...
![excel-to-powerbi-animated-diagram](assset/images/kaggle_to_powerbi.gif)
...
![Dashboard-Mockup](assset/images/dashboard_mockup.png)
...
![Row count check](assset/images/1_row_count_check.png)
...
```
### Output 
![Column count check](assset/images/2_column_count_check.png)
...
```
### Output
![Data type check](assset/images/3_data_type_check.png)
...
```
### Output
![Duplicate count check](assset/images/4_duplicate_records_check.png)
...
![GIF of Power BI Dashboard](assset/images/top_uk_youtubers_2024.gif)
...
![Most subsc](assset/images/youtubers_with_the_most_subs.png)
...
![Most videos](assset/images/youtubers_with_the_most_videos.png)
...
![Most views](assset/images/youtubers_with_the_most_views.png)
